...
import unittest
from classes.GestorImagen import GestorImage

class testGestor(unittest.TestCase):

    def testBuscadorColores(self):
        imagen1 = GestorImage('assets/example_1.bmp')
        ...
        imagen2 = GestorImage('assets/example_2.bmp')
        ...
        imagen3 = GestorImage('assets/example_3.bmp')
        ...
        imagen4 = GestorImage('assets/example_4.bmp')
        ...
        imagen5 = GestorImage('assets/example_5.bmp')
